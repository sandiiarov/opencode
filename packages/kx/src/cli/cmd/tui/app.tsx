...
function App(props: { onSnapshot?: () => Promise<string[]> }) {
  ...
  createEffect(() => {
    if (!terminalTitleEnabled() || Flag.KX_DISABLE_TERMINAL_TITLE) return

    if (route.data.type === "home") {
      renderer.setTerminalTitle("K(x)")
      return
    }
    ...
    if (route.data.type === "session") {
      ...
      renderer.setTerminalTitle(`K(x) | ${title}`)
    }
  })
  ...
  command.register(() => [
    ...
    ...(Flag.KX_EXPERIMENTAL_WORKSPACES
      ? [
          {
  ...
  return (
    <box
      ...
      onMouseUp={Flag.KX_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? undefined : () => Selection.copy(renderer, toast)}
    >
      <Switch>
...
function ErrorComponent(props: {
  ...
  const issueURL = new URL("https://github.com/anomalyco/kx/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("kx-version", Installation.VERSION)
