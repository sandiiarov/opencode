...
export namespace FileWatcher {
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@kx/FileWatcher") {}
    ...
    Effect.gen(function* () {
      const state = yield* InstanceState.make(
        Effect.fn("FileWatcher.state")(
          function* () {
            if (yield* Flag.KX_EXPERIMENTAL_DISABLE_FILEWATCHER) return
            ...
            if (yield* Flag.KX_EXPERIMENTAL_FILEWATCHER) {
