...
export namespace Skill {
  ...
  const KX_SKILL_PATTERN = "{skill,skills}/**/SKILL.md"
  ...
  const create = (discovery: Discovery.Interface, directory: string, worktree: string): Cache => {
    ...
    const load = async () => {
      if (!Flag.KX_DISABLE_EXTERNAL_SKILLS) {
      ...
      for (const dir of await Config.directories()) {
        await scan(state, dir, KX_SKILL_PATTERN)
      }
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@kx/Skill") {}
