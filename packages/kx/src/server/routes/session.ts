  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all kx sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific kx session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new kx session for interacting with AI assistants and managing conversations.",
    ...
    .post(
      ...
      describeRoute({
        ...
        description:
          "Analyze the current application and create or improve a concise, repo-specific AGENTS.md for coding agents.",
