...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@kx/plugin"
import z from "zod"
...
export namespace ToolRegistry {
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@kx/ToolRegistry") {}
    ...
    Effect.gen(function* () {
      ...
      async function all(custom: Tool.Info[]): Promise<Tool.Info[]> {
        ...
        return [
          ...
          CodeSearchTool,
          SkillTool,
          ...(Flag.KX_EXPERIMENTAL_LSP_TOOL ? [LspTool] : []),
          ...(cfg.experimental?.batch_tool === true ? [BatchTool] : []),
          ...(Flag.KX_EXPERIMENTAL_PLAN_MODE && Flag.KX_CLIENT === "cli" ? [PlanExitTool] : []),
          ...custom,
        ]
      }
