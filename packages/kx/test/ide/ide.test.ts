...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders KX_CALLER", () => {
    process.env["KX_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode KX_CALLER", () => {
    process.env["KX_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown KX_CALLER", () => {
    process.env["KX_CALLER"] = "unknown"
