...
export function MessageToolBash(props: { message: AssistantEntry; part: ToolPart }) {
  ...
  return (
    <Message color={theme.accent.success} onPress={() => {}}>
      <MessageHeader>
        <MessageIcon color={theme.accent.success} isLoading={props.part.state.status === "running"}>
          {icons.bash}
        </MessageIcon>
        <MessageTitle color={theme.accent.success}>Bash</MessageTitle>
