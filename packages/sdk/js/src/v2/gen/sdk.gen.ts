...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new KxClient()" to fix this error.`)
    }
    return instance
  }
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global kx configuration settings and preferences.
   */
   ...
   *
   * Update global kx configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the kx server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the kx system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all kx instances, releasing all resources.
   */
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with kx.
   */
   ...
   * Get current project
   *
   * Retrieve the currently active project that kx is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by kx.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current kx configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update kx configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all kx sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new kx session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific kx session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current kx instance, releasing all resources.
   */
...
export class Path extends HeyApiClient {
   ...
   * Get paths
   *
   * Retrieve the current working directory and related path information for the kx instance.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the kx system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the kx system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the kx system.
   */
...
export class KxClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<KxClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    KxClient.__registry.set(this, args?.key)
  }
